...
#model maladie
SVMModelMaladie = SVMModelMaladie()

# Chargement des données
maladie_data = import_data('datasets/maladie.csv')

# Séparation des données en ensembles d'entraînement et de test
maladie = maladie_data['maladie']
labels = np.where(emails_data['label'] == 'maladie', 1, 0)  # Encoder les étiquettes en 0 et 1
